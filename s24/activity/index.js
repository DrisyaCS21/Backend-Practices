...
function getArtistsArray(){
    const favArtist = ["Ben & Ben","Arthur Nery","Linkin Park","Paramore","Taylor Swift"];
    return favArtist;
}
...
function getSongsArray(){
    const songs=["Kathang Isip", "Binhi","In the End","Bring by Boring Brick","Love Story"]
    return songs;
}
const favSongs = getSongsArray();
...
function getMoviesArray(){
    const movies = ["The Lion King ", "Meet the Robinsons","Howl's Moving Castle","Tangled","Frozen"]
    return movies
}
const favMovies = getMoviesArray();
