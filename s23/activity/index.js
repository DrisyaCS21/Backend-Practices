...
*/
    ...
    console.log("How many characters are in the world?");
...
console.log("There are " + resultMinutes + " minute in a year.");
...
console.log(" 132 degree Celsius when converted to Farenheit is " + resultFahrenheit);
...
let num7 = 165;
let reminder = num7 % 8;
console.log("The remainder of 165 divided  by 8 is: " + reminder);
...
let variable = num8 % 4;
//Log the value of the remainder in the console.
console.log("the reminder of 348 divided by 4 is: " + variable);
console.log("Is num8 divisible by 4?");
let isDivisibleBy4 = variable === 0;
